...
public interface BookRepository extends JpaRepository<Book, Long> {
     ...
     */
    Book findBookByTitle(String title); // TODO: Retrieve a book by its title

    /**
     * TODO: Retrieve books by their availability using their available field. The return type will be List<Book>.
     */
    List<Book> findBooksByAvailable(boolean available); // TODO: Retrieve books by their availability
    /**
     * TODO: Retrieve books by their dateAdded OR their lastDateWithdrawn.
     */
    List<Book> findBooksByDateAddedOrLastDateWithdrawn(Timestamp dateAdded, Timestamp lastDateWithdrawn); // TODO: Retrieve books by their dateAdded OR lastDateWithdrawn
}
